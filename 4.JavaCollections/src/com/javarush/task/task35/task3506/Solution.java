...
public class Solution {
    // H extends D
    // S extends H
    // т.е. D - Родитель всем имеющимся в примере денерикам и destinationList - есть список,
    // который может принимать своих потомков в список, т.е. списки видов ? extends D
    // сам не допер сходу не мог понять почему список откахывается принимать в destListIterator.add(..)
    // др список паратметрезированный просто <?>
