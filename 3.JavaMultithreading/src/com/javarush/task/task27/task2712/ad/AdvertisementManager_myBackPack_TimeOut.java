...
public class AdvertisementManager_myBackPack_TimeOut {
    ...
    private int currentDurationMinutes; // длительность всех роликов списка, не должна быть больше чем timeSeconds
    ///////////

    public AdvertisementManager_myBackPack_TimeOut(int timeSeconds) {
