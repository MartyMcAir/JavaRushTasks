...
// From https://github.com/black45/JavaRush/blob/master/task2712/ad/AdvertisementManager.java
// Валя не принял
public class AdvertisementManager_NotMyV1 {
    private final AdvertisementStorage storage = AdvertisementStorage.getInstance();
    private int timeSeconds;

    public AdvertisementManager_NotMyV1(int timeSeconds) {
