...
//        System.out.println(Modifier.toString(classModifiers)); // public
...
//        System.out.println(Modifier.toString(methodModifiers)); // public static
        System.out.println(isModifierSet(methodModifiers, Modifier.STATIC));      //true
    }

    public static boolean isModifierSet(int allModifiers, int specificModifier) {
//        return (allModifiers & specificModifier) == specificModifier;  // (allModifiers & specificModifier)>0
//        return Modifier.toString(allModifiers).equals(Modifier.toString(specificModifier));
