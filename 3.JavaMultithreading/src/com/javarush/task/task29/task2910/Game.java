...
public class Game {
    ...
    private void initializeControlSportsman() {
        ...
        controlSportsman.setResultTime(new BigDecimal("3640.00")); /// HERE
...
//            BigDecimal res = members.get(i).getResultTime();
//            BigDecimal controlRes = controlSportsman.getResultTime();
//            if (res.equals(controlRes)) {
