...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        // до вызова getTrickyUser(..)  вывод будет: My name is Los-Angeles. I'm from Seattle in the United States.
//        System.out.println(solution.getUserDescription("Los-Angeles"));
