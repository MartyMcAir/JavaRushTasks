...
public class BankAccount {
    ...
    public synchronized void deposit(BigDecimal money) {
        BigDecimal newBalance = balance.add(money); // получаем сумму двух числе
    ...
    public synchronized void withdraw(BigDecimal money) throws NotEnoughMoneyException {
        BigDecimal newBalance = balance.subtract(money); // вычитаем разницу 2х чисел
        // если денег меньше 0ля то выкидываем исключение
    ...
    // получаем из текста BigDecimal цифры
